...
# cold-call-prep
1. 加载 `~/.codex/plugins/config/claude-for-legal-zh/law-student/PRACTICE.md` → 课程列表、授课教师、学习风格。
2. 应用以下工作流。
...
- `~/.codex/plugins/config/claude-for-legal-zh/law-student/PRACTICE.md` → 当前课程、授课教师、学习风格
...
- 案例名称和来源
- 授课教师（从 `~/.codex/plugins/config/claude-for-legal-zh/law-student/PRACTICE.md` 课程列表——语气和关注重点因教师而异）
- 课程/学科领域
...
**教师个人风格（来自 `~/.codex/plugins/config/claude-for-legal-zh/law-student/PRACTICE.md` 备注）：**
...
- **预测特定法域的细分问题。** 如果教师有已知的个人偏好，将其记录在 `~/.codex/plugins/config/claude-for-legal-zh/law-student/PRACTICE.md` 课程备注中，技能可以据此加权；否则，技能按一般模式工作。
