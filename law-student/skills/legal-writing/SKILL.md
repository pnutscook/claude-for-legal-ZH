...
# legal-writing
1. 加载 `~/.codex/plugins/config/claude-for-legal-zh/law-student/PRACTICE.md` → 课程、写作水平、既往反馈模式。
2. 应用以下框架。
...
7. 追加到 `~/.codex/plugins/config/claude-for-legal-zh/law-student/writing-feedback/[学生]/tracker.md` 用于模式检测。
...
- `~/.codex/plugins/config/claude-for-legal-zh/law-student/PRACTICE.md` → 课程、作业类型（如已知）、写作水平、既往批改反馈
- 学生提供的草稿
- 可选：评分标准或作业要求（如学生提供）
...
追加练习摘要到 `~/.codex/plugins/config/claude-for-legal-zh/law-student/writing-feedback/[学生]/tracker.md`：
