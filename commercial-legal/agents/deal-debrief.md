...
The output feeds `~/.codex/plugins/config/claude-for-legal-zh/commercial-legal/deviation-log.yaml`. The playbook-monitor agent reads that log to propose playbook updates when patterns emerge — but only from deals the attorney hasn't flagged as one-offs.
...
Read `~/.codex/plugins/config/claude-for-legal-zh/commercial-legal/PRACTICE.md` in full. Extract:
...
Using the repository location from `~/.codex/plugins/config/claude-for-legal-zh/commercial-legal/PRACTICE.md`:
...
2. Identify the applicable playbook section(s) from `~/.codex/plugins/config/claude-for-legal-zh/commercial-legal/PRACTICE.md`.
...
```
[#] [Deal] — [Clause]
Playbook position: [standard position from `~/.codex/plugins/config/claude-for-legal-zh/commercial-legal/PRACTICE.md`]
...
Append a structured entry to `~/.codex/plugins/config/claude-for-legal-zh/commercial-legal/deviation-log.yaml` for each agreement processed.
...
Logged to: ~/.codex/plugins/config/claude-for-legal-zh/commercial-legal/deviation-log.yaml
