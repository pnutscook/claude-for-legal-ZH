...
description: >
  ...
  Runs weekly by default. Posts to the channel named in `~/.codex/plugins/config/claude-for-legal-zh/commercial-legal/PRACTICE.md` → House style
...
1. Read `~/.codex/plugins/config/claude-for-legal-zh/commercial-legal/PRACTICE.md` to get the alert destination (Slack channel or email list).
