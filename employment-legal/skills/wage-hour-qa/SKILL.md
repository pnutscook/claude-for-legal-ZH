...
# wage-hour-qa
1. 加载 `~/.codex/plugins/config/claude-for-legal-zh/employment-legal/PRACTICE.md` → 管辖范围。
2. 使用以下工作流。
...
`~/.codex/plugins/config/claude-for-legal-zh/employment-legal/PRACTICE.md` → 管辖范围。如果问题未指定管辖地，询问——或以员工最多的管辖地回答并注明。
