...
Read `~/.codex/plugins/config/claude-for-legal-zh/employment-legal/PRACTICE.md` → jurisdictional footprint, escalation table, any existing
expansion notes.

## Output header

Prepend the work-product header from `~/.codex/plugins/config/claude-for-legal-zh/employment-legal/PRACTICE.md` → `## Outputs` (it differs by user role — see `## Who's using this`).
...
Write a new file to `~/.codex/plugins/config/claude-for-legal-zh/employment-legal/expansion-[country-slug].yaml` with all open items
...
**Roles:** [list]
**Tracker:** ~/.codex/plugins/config/claude-for-legal-zh/employment-legal/expansion-[slug].yaml
