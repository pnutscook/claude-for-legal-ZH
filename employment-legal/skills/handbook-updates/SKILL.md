...
`~/.codex/plugins/config/claude-for-legal-zh/employment-legal/PRACTICE.md` → 规章制度位置、省级补充条款列表、更新频率。
...
对于 `~/.codex/plugins/config/claude-for-legal-zh/employment-legal/PRACTICE.md` 中的每个省/直辖市补充条款：
