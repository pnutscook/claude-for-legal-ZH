...
User-specific configuration for this plugin lives at a version-independent path that survives plugin updates:
  ...
  ~/.codex/plugins/config/claude-for-legal-zh/ai-governance-legal/PRACTICE.md
...
4. On first run after a plugin update, if a populated PRACTICE.md exists at the old cache path
   (~/.codex/plugins/cache/claude-for-legal-zh/ai-governance-legal/<version>/PRACTICE.md for any version)
...
**清单文件：** `~/.codex/plugins/config/claude-for-legal-zh/ai-governance-legal/ai-systems.yaml`
...
**验证日志。** 记录到 `~/.codex/plugins/config/claude-for-legal-zh/ai-governance-legal/verification-log.md`。
